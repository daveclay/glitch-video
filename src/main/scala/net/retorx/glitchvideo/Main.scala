...
import net.retorx.glitchvideo.player.{SwingPlayer, PlayMedia, XugglePlayer}
import PlayMedia._
...
object Main {
    ...
    def main(args: Array[String]) = {
        ...
        val player = new SwingPlayer("videos/CSPAN2_20120828_103000_Book_TV.mp4?t=1795%2F1825&ignore=x.mp4")
        player.play()
